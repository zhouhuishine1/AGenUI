...
Object.defineProperty(exports, "loadConfigAsync", {
  enumerable: true,
  get: function () {
    return _cliConfig().loadConfigAsync;
  }
});
exports.run = run;
function _cliConfig() {
  const data = _interopRequireWildcard(require("@react-native-community/cli-config"));
  _cliConfig = function () {
    return data;
  };
  return data;
...
//# sourceMappingURL=/Users/szymonrybczak/Developer/cli/packages/cli/build/index.js.map