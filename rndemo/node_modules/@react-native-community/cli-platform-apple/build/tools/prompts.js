...
async function promptForDeviceSelection(devices) {
  const {
    device
  } = await (0, _cliTools().prompt)({
    type: 'select',
...
//# sourceMappingURL=/Users/szymonrybczak/Developer/cli/packages/cli-platform-apple/build/tools/prompts.js.map