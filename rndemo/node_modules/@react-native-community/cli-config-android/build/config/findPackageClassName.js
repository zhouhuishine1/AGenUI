...
function matchClassName(file) {
  ...
  if (nativeModuleMatch) {
    ...
    return file.match(/class\s+(\w+[^(\s]*)[\s\w():]*(\s+extends\s+|:)[\s\w():,]*[^{]*(Turbo|Base)ReactPackage/);
  }
}

//# sourceMappingURL=/Users/szymonrybczak/Developer/cli/packages/cli-config-android/build/config/findPackageClassName.js.map