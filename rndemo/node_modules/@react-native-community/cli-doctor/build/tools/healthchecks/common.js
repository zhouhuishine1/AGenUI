...
function calculateMessageSize(message) {
  return Math.max(1, Math.ceil((0, _wcwidth().default)(_util().default.stripVTControlCharacters(message)) / (process.stdout.columns || 80)));
}
...
//# sourceMappingURL=/Users/szymonrybczak/Developer/cli/packages/cli-doctor/build/tools/healthchecks/common.js.map