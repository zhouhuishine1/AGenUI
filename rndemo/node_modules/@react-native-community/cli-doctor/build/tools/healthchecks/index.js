...
const getHealthchecks = async ({
  ...
  const defaultHealthchecks = {
    ...
    ...(process.platform === 'darwin' ? {
      ios: {
        label: 'iOS',
        healthchecks: [_xcode.default, _ruby.default, _cocoaPods.default]
      }
    } : {}),
    ...additionalChecks
  };
...
//# sourceMappingURL=/Users/szymonrybczak/Developer/cli/packages/cli-doctor/build/tools/healthchecks/index.js.map