...
const doctorCommand = async (_, options, config) => {
  ...
  const healthchecksPerCategory = await iterateOverCategories(Object.values(await (0, _healthchecks.getHealthchecks)(options)).filter(category => category !== undefined));
  loader.stop();
  const stats = {
    errors: 0,
    warnings: 0
...
//# sourceMappingURL=/Users/szymonrybczak/Developer/cli/packages/cli-doctor/build/commands/doctor.js.map